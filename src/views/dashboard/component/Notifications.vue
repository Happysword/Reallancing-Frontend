<template>
  <v-container id="alerts" fluid tag="section">
        ...
        <v-card>
          <v-card-text>
            ...
            <base-material-alert color="primary" dark dismissible icon="mdi-bell">
              You can see that the icon and the close button are always vertically aligned. This is
        ...
        <v-card>
          <v-card-text>
            ...
            <base-material-alert color="pink darken-1" dark dismissible>
              <span>PINK DARKEN-1</span> — This is a regular alert made with the color "pink
              darken-1"
            </base-material-alert>
          </v-card-text>
        </v-card>
    ...
    >
      Welcome to <span class="font-weight-bold">&nbsp;MATERIAL DASHBOARD&nbsp;</span> — a beautiful
      admin panel for every web developer.
    </base-material-snackbar>
          ...
          <v-row>
            <v-col cols="12" md="8">
              <div>
                ...
                <div class="grey--text">
                  The first step is to create an account at Creative Tim. You can choose a social
                  network or go for the classic version, whatever works best for you.
                </div>
              </div>
            </v-col>
            ...
            <v-col cols="12" md="8">
              <div>
                ...
                <div class="grey--text">
                  ...
                  <a href="http://www.creative-tim.com/">Creative Tim</a>. You can choose a social
                  network or go for the classic version, whatever works best for you.
                </div>
              </div>
            </v-col>
            ...
            <v-col cols="12">
              If you have more questions, don't hesitate to contact us or send us a tweet
              @creativetim. We're here to help!
            </v-col>
          </v-row>
